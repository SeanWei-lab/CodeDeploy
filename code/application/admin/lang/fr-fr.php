...
return [
    ...
    'The upgrade package has exceeded 3M, please adjust the "upload_max_filesize" configuration in php.ini, it is recommended to set it to greater than 4M, otherwise the upgrade may fail' => 'Le package de mise à niveau a dépassé 3M, veuillez ajuster la configuration "upload_max_filesize" dans php.ini, il est recommandé de la définir à une valeur supérieure à 4M, sinon la mise à niveau peut échouer',

...
return [
    ...
    'Never logged in' => 'Nie eingeloggt',
    'Push' => 'Drücken',
    'Pull' => 'Ziehen',
    'Are you sure you want to push?' => 'Bist du sicher, dass du pushen willst?',
    'After pushing, you can pull in the browser of any terminal and continue editing' => 'Nach dem Drücken können Sie den Browser eines beliebigen Terminals aufrufen und die Bearbeitung fortsetzen',
    'Already pushed' => 'Schon geschoben',
    'Your operation is illegal' => 'Ihre Operation ist illegal',
    'The content you pulled was not found' => 'Der von Ihnen gezogene Inhalt wurde nicht gefunden',
    'Failure' => 'Fehler',
    'Pull success' => 'Erfolg ziehen',
    'The upgrade package has exceeded 3M, please adjust the "upload_max_filesize" configuration in php.ini, it is recommended to set it to greater than 4M, otherwise the upgrade may fail' => 'Das Upgrade-Paket hat 3M überschritten. Passen Sie die Konfiguration "upload_max_filesize" in der php.ini an. Es wird empfohlen, sie auf mehr als 4M festzulegen, da sonst das Upgrade fehlschlagen kann',
    'Save as template' => 'Als Vorlage speichern',
    'Choose template' => 'Vorlage wählen',
    'Saving template' => 'Vorlage speichern',
    'Template saved successfully' => 'Vorlage erfolgreich gespeichert',
    'Template name' => 'Vorlagenname',
    'The template name already exists, you can change the template name, or modify the existing template' => 'Der Vorlagenname ist bereits vorhanden. Sie können den Vorlagennamen ändern oder die vorhandene Vorlage ändern',
    'Loading existing templates' => 'Laden vorhandener Vorlagen',
    'Template not found' => 'Vorlage nicht gefunden',
    'Preview' => 'Vorschau',
    'Use' => 'Verwenden',
    'Annex' => 'annektieren',
    'Choose a file' => 'Wähle eine Datei aus',
    'Attachment address' => 'Anhangsadresse',
    'You can also enter the attachment address' => 'Sie können auch die Anhangsadresse eingeben',
    'Separate multiple attachment addresses with commas' => 'Trennen Sie mehrere Anhangsadressen durch Kommas',
    'Source address' => 'Quelladresse',
    'ICP record' => 'ICP-Aufzeichnung',
    'Public security record' => 'Öffentliche Sicherheitsakte',
    'Select icon' => 'Symbol auswählen',
    'You did not select any icons' => 'Sie haben keine Symbole ausgewählt',
    'Adjust size' => 'Größe anpassen',
    'Theme upload' => 'Thema hochladen',
    'Select zip file' => 'Wählen Sie eine Zip-Datei',
    'The uploaded zip file is not available' => 'Die hochgeladene Zip-Datei ist ungültig',

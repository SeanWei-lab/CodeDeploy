...
return [
    ...
    'Push' => '押す',
    'Pull' => '引く',
    'Are you sure you want to push?' => 'プッシュしてもよろしいですか？',
    'After pushing, you can pull in the browser of any terminal and continue editing' => 'プッシュした後、任意の端末のブラウザをプルして編集を続行できます',
    'Already pushed' => 'プッシュ済み',
    'Your operation is illegal' => 'あなたの操作は違法です',
    'The content you pulled was not found' => 'プルしたコンテンツが見つかりませんでした',
    'Failure' => '失敗',
    'Pull success' => '成功を引き出す',
    'The upgrade package has exceeded 3M, please adjust the "upload_max_filesize" configuration in php.ini, it is recommended to set it to greater than 4M, otherwise the upgrade may fail' => 'アップグレードパッケージが3Mを超えています。php.iniの「upload_max_filesize」設定を調整してください。4Mより大きい値に設定することをお勧めします。それ以外の場合、アップグレードは失敗する可能性があります',
    'Save as template' => 'テンプレートとして保存する',
    'Choose template' => 'テンプレートを選択',
    'Saving template' => 'テンプレートを保存しています',
    'Template saved successfully' => 'テンプレートを保存しました',
    'Template name' => 'テンプレート名',
    'The template name already exists, you can change the template name, or modify the existing template' => 'テンプレート名は既に存在します。テンプレート名を変更するか、既存のテンプレートを変更できます',
    'Loading existing templates' => '既存のテンプレートを読み込んでいます',
    'Template not found' => 'テンプレートが見つかりません',
    'Preview' => 'プレビュー',
    'Use' => '使用する',
    'Annex' => '別館',
    'Choose a file' => 'ファイルを選択',
    'Attachment address' => '添付アドレス',
    'You can also enter the attachment address' => '添付アドレスを入力することもできます',
    'Separate multiple attachment addresses with commas' => '複数の添付ファイルアドレスをカンマで区切ります',
    'Source address' => '送信元アドレス',
    'ICP record' => 'ICPレコード',
    'Public security record' => '公安記録',
    'Select icon' => 'アイコンを選択',
    'You did not select any icons' => 'アイコンを選択していません',
    'Adjust size' => 'サイズを調整する',
    'Theme upload' => 'テーマのアップロード',
    'Select zip file' => 'zipファイルを選択',
    'The uploaded zip file is not available' => 'アップロードされたzipファイルが無効です',
